...
def postfilter2(scores, boxes, class_map, max_per_image=100, thresh=0.05, nms_thresh=0.3):
    '''
    not use json.dump to dump the result
    '''
...
def tsvdet_iter(caffemodel, input_images, **kwargs):
    ...
    for im in input_images:
        ...
        results = postfilter2(scores,boxes, cmap)
        yield results
