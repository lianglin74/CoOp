...
def splitByVideoIds(tsvOrgFile):
    ...
    videoToTestFile = ['1551538896210_sc99_01.mp4', '647b025243d74e719b36d24a0c19df37_sc99_.mp4',
                       '5102216385_5004650317_92.mp4', '1552493137730_sc99_01.mp4', '1552141947911_sc99_01.mp4']
...
def workOnCBA_0():
    splitByVideoIds(
        "/mnt/gavin_ivm_server2_IRIS/ChinaMobile/Video/TSV_1frame/split_CBA_video_0/CBA_video_0.withLabel.correct.tsv")
