import os
from evaluation.uhrs import UhrsTaskManager, State


def test():
    # rootpath is where you have your task id file. Here an example is provided.
    rootpath = "//ivm-server2/iris/ChinaMobile/Video/uhrs/"
    task_group = "cv_internal"

    # log.txt contains the task id to download
    uhrs_client = UhrsTaskManager(
        os.path.join(rootpath, "log_CBA_2_part_2_3.txt"))
