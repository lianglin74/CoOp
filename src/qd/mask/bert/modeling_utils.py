...
class PreTrainedModel(nn.Module):
    ...
    def save_pretrained(self, save_directory, **kwargs):
        ...
        if '_use_new_zipfile_serialization' in kwargs:
            extra_param = {'_use_new_zipfile_serialization': kwargs['_use_new_zipfile_serialization']}
        else:
            extra_param = {}
        torch.save(model_to_save.state_dict(), output_model_file, **extra_param)
    ...
    def _generate_no_beam_search(
        ...
        while cur_len < max_length:
            model_inputs = self.prepare_inputs_for_generation(input_ids, past=past)
            #logging.info('floping')
            #del model_inputs['is_training']
            #del model_inputs['encoder_history_states']
