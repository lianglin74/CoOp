...
from qd.mask.modeling.rpn.retinanet.retinanet import build_retinanet
from qd.mask.modeling.rpn.fcos.fcos import build_fcos
...
class RPNHeadFeatureSingleConv(nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        if cfg.MODEL.RPN.HIDDEN_FEAT_DIM > 0:
            out_channels = cfg.MODEL.RPN.HIDDEN_FEAT_DIM
        else:
