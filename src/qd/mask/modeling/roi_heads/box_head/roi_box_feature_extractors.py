...
from qd.mask.modeling.backbone import resnet
from qd.mask.modeling.poolers import Pooler
from qd.mask.modeling.make_layers import group_norm
from qd.mask.modeling.make_layers import make_fc
...
class ResNet50Conv5ROIFeatureExtractor(nn.Module):
    def __init__(self, config, in_channels):
        ...
        head = resnet.ResNetHead(
            ...
            use_se=config.MODEL.RESNETS.USE_SE
        )
