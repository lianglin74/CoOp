...
class AttributeRCNNPredictor(nn.Module):
    def __init__(self, cfg, in_channels):
        ...
        num_classes = cfg.MODEL.ROI_ATTRIBUTE_HEAD.NUM_ALIGNED_CLASSES if cfg.MODEL.ROI_ATTRIBUTE_HEAD.NUM_ALIGNED_CLASSES > 0 else cfg.MODEL.ROI_BOX_HEAD.NUM_CLASSES
