...
class GeneralizedRCNN(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        if not self.training and self.force_boxes and targets is not None:
            if all(len(t) == 0 for t in targets):
                # in this special case, we return the result immediately.
                # otherwise, it could crash at some points.
                return targets
