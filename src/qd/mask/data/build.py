...
from qd.mask.utils.imports import import_file
...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0):
    ...
    from qd.mask.config.paths_catalog import DatasetCatalog
    #paths_catalog = import_file(
        #"qd.mask.config.paths_catalog", cfg.PATHS_CATALOG, True
    #)
