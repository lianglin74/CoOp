...
class TestProcessImage(unittest.TestCase):
    def test_url_to_3_channel_image(self):
        ...
        urls = [
                ...
                "http://1.bp.blogspot.com/-d0u0HcF1ycA/VP3ytOjMJ1I/AAAAAAAADC0/bZFXDzuB_mo/s1600/microsoft-azure.png",# png with noisy alpha channel
                "https://www.charter.com/content/dam/spectrum/residential/en/images/ra/refresh-tv/starzencore-logo.png"
                ]
