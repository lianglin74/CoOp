...
from fast_human_det.config import cfg
...
class FastHumanDetPipeline(MaskClassificationPipeline):
    def __init__(self, **kwargs):
        ...
        config_file = '/home/jianfw/code/others/Xiyang/FastHumanDetector/tools/fcos_R_34_v2_FPN_coco_inference.yaml'
        ...
        dict_update_path_value(self.kwargs,
                               ...
                               self.num_workers)
        self.kwargs['PATHS_CATALOG'] = './src/maskrcnn-benchmark/maskrcnn_benchmark/config/paths_catalog.py'
    ...
    def get_train_model(self):
        from fast_human_det.modeling.detector import build_detection_model
